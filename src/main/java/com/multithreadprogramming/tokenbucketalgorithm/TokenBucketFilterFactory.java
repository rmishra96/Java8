...
import com.multithreadprogramming.tokenbucketalgorithm.TokenBucketFilter1;
...
public final class TokenBucketFilterFactory {
    ...
    static public TokenBucketFilter1 makeTokenBucketFilter(int capacity) {
        MultithreadedTokenBucketFilter tbf = new MultithreadedTokenBucketFilter(capacity);
        tbf.initialize();
        return tbf;
    }

    private static class MultithreadedTokenBucketFilter extends TokenBucketFilter1{
